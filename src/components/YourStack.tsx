...
if(selectedCart.length===0){
  ...
  return (
    <div className="rounded-3xl border  bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1  hover:shadow-lg">
        ...
        return (
          <div>
            <div className="card container mx-auto ">
              ...
              <div className=" py-5">
                <div className="container mx-auto flex justify-between border rounded-[10px] ">
                  ...
                  <div onClick={()=>{hendelRemoveCart(technologiesCart)}} className=" text-2xl flex items-center mr-1.5 ">
            ...
            <button onClick={()=>{setSelectedCart([])}} className="mt-5 w-full rounded-xl border text-[15px]  py-3 text-sm font-semibold text-red-600 bg-white border-red-400 transition-all duration-300  active:scale-[0.98]">
              Remove All
            </button>
